...
<Center><h1 class="h1">Transformando Asesorías y Gestión</h1></Center>
  <br>
  <hr>
    ...
    <table border="1" class="tabla_2">
      <tr>
        <th colspan="11" class="titulo">Trabajadores
        </th>
    </tr> 
        <tr class="puntos">
            <th></b>#</th>
